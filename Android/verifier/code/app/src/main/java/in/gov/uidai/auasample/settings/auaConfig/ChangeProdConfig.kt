...
class ChangeProdConfig : Fragment() {
...
//        (activity as AppCompatActivity).supportActionBar?.setDisplayHomeAsUpEnabled(true)
        (activity as AppCompatActivity).supportActionBar?.title = "Prod Configurations"
...
//            }
//        }
//        config_heading.text = "Prod Configurations"
        ...
        reset_Configs.setOnClickListener {
            ConfigUtils.resetConfig(requireContext(), ConfigUtils.PROD_CONFIG_DATA)
//            dismiss()
        }
    }
    ...
    private fun saveConfigsToLocal() {
        if (validateForm()) {
            ...
            ConfigUtils.saveConfigData(configParams, ConfigUtils.PROD_CONFIG_DATA)
...
//            dismiss()
    ...
    private fun populateConfigFields() {
        val configParams = ConfigUtils.getConfigData(ConfigUtils.PROD_CONFIG_DATA)
